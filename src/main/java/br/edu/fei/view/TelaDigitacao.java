...
public class TelaDigitacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textoDigitadoArea.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                textoDigitadoAreaKeyPressed(evt);
            }
        });
    ...
    private void textoDigitadoAreaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoDigitadoAreaKeyPressed
        if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {//apertar enter
            evt.consume();
            confirmaBtn.doClick();
        }
    }//GEN-LAST:event_textoDigitadoAreaKeyPressed
